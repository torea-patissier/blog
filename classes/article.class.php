...
{   
    ...
    {   
        ...
        echo "<div class='borderArt'> Posté le " . $dateArticle . " par  " . $userName . ":<br /><br />";
        echo $article . "<br /><br /><hr></div>";
    ...
    function showComments()
    {
        ...
        foreach($result as $key){
            ...
            echo "<div class='borderCommentaire'>Commentaire du : " . $dateCommentaire . "par : " . $username . "<br />" . $commentaire . "</div><br /><br />";
        }
